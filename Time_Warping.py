# -*- coding: utf-8 -*-
"""COMP330_A6_TASK2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1cN9Spv2-Kw7z4ILEZklmdHv3rYT3VoWI
"""
...
Wfir = tf.Variable(np.random.normal(0, 0.01, (hiddenUnits + 256 + hiddenUnits, hiddenUnits)), dtype=tf.float32)
...
for timeTick in sequenceOfLetters:
    ...
    inputPlusState = tf.concat([timeTick, currentState, tenth_state], 1)
